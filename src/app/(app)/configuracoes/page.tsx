  ...
  return (
    <div className="flex flex-col gap-5">
      <div>
        ...
        <p className="text-sm text-muted">Gerencie as configurações da sua operação.</p>
      </div>
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          ...
          <div>
            <p className="font-semibold text-ink">Sites e pontos</p>
            <p className="mt-0.5 text-sm text-muted">Gerencie lojas, pontos e centros de distribuição.</p>
          </div>
        </Link>
        <Link
        ...
        >
          ...
          <div>
            ...
            <p className="mt-0.5 text-sm text-muted">Defina as formas de pagamento aceitas por loja.</p>
          </div>
        </Link>
      </div>
    </div>
