...
import { EstadoVazio, Metrica, MetricaGrid, fmtMoney, fmtQuando } from "../_catalogo/ui";
  ...
  async function enviar(arquivos: FileList | File[]) {
    ...
    try {
      ...
      if (importadas.length === 1 && unica?.inboundId) {
        ...
        router.push(`/compras/recebimento/${unica.inboundId}`);
        return;
      }
